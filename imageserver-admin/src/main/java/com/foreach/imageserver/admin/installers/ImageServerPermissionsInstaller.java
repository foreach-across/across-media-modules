...
@Installer(description = "Define ImageServer administration permissions, assigns them to ROLE_ADMIN and ROLE_IMAGESERVER_ADMIN.",
...
public class ImageServerPermissionsInstaller {
    ...
    private void createPermissionGroupAndPermissions() {
        permissionService.definePermission("imageserver view images",
                "The user can view images and access the imageserver administrative interface.", "imageserver");
        permissionService.definePermission("imageserver upload images", "The user can upload images.", "imageserver");
        permissionService.definePermission("imageserver manage resolutions", "The user can modify and create image resolutions.", "imageserver");
    ...
    private void assignPermissionsToExistingRole() {
        ...
        if (role != null) {
            role.addPermission("imageserver view images", "imageserver upload images", "imageserver manage resolutions");
        ...
        roleService.defineRole(
                ...
                Arrays.asList("imageserver view images", "imageserver upload images", "imageserver manage resolutions")
        );
    }
}
