...
public class ImageUtils {
    ...
    public static boolean imagesAreEqual(BufferedImage image1, BufferedImage image2) throws IOException {
        ...
        double[] imageData1 = image1.getData().getPixels(0, 0, image1.getWidth(), image1.getHeight(), (double[]) null);
        double[] imageData2 = image2.getData().getPixels(0, 0, image2.getWidth(), image2.getHeight(), (double[]) null);
