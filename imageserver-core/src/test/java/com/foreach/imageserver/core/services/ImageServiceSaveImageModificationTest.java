...
public class ImageServiceSaveImageModificationTest {
    ...
    public ImageServiceSaveImageModificationTest(int cropX, int cropY, int cropWidth, int cropHeight, int imageWidth, int imageHeight, boolean throwsError, String situation) {
    ...
    public void saveImageModification() throws Exception {
        try {
            imageService.saveImageModification(createModification(cropX, cropY, cropWidth, cropHeight), createImage(imageWidth, imageHeight));
