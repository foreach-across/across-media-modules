...
public class ImageModificationDaoTest extends AbstractIntegrationTest {
    ...
    public void insertAndGetById() {
        ...
        String imageSql = "INSERT INTO IMAGE ( id, created, width, height, imageTypeId ) VALUES ( ?, ?, 1, 1, 1 )";
    ...
    public void getAllModifications() {
        ...
        List<ImageModification> modifications = imageModificationDao.getAllModifications(9998);
