...
public class WebCmsTypeSpecifierLink extends SettableIdAuditableEntity<WebCmsTypeSpecifierLink>
{
	...
	@GenericGenerator(
			name = "seq_wcm_object_type_link_id",
			strategy = AcrossSequenceGenerator.STRATEGY,
			parameters = {
					@org.hibernate.annotations.Parameter(name = "sequenceName", value = "seq_wcm_object_type_link_id"),
	...
	/**
	 * The type specifier being linked to.
	 */
	@NotNull
	@ManyToOne
	...
	protected WebCmsTypeSpecifierLink( Long id,
	                                   Long newEntityId,
	                                   String createdBy,
	                                   Date createdDate,
