...
/**
 * Responsible for building a {@link PlaceholderWebCmsComponentModel}.
 *
...
class PlaceholderWebCmsComponentAutoCreateStrategy implements WebCmsComponentAutoCreateStrategy<PlaceholderWebCmsComponentModel>
{
	@Override
	...
	public void buildComponentModel( WebCmsComponentAutoCreateService autoCreateService,
	                                 PlaceholderWebCmsComponentModel componentModel,
	                                 WebCmsComponentAutoCreateTask task ) {
		componentModel.setPlaceholderName( task.getComponentName() );
	}
}
