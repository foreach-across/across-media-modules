...
public class PlaceholderWebCmsComponentModelReader extends AbstractWebCmsComponentModelReader<PlaceholderWebCmsComponentModel>
{
	@Override
	public boolean supports( WebCmsComponent component ) {
		return PlaceholderWebCmsComponentModel.TYPE.equals( component.getComponentType().getAttribute( WebCmsComponentModel.TYPE_ATTRIBUTE ) );
	}

	@Override
	protected PlaceholderWebCmsComponentModel buildComponentModel( WebCmsComponent component ) {
		return new PlaceholderWebCmsComponentModel( component );
	}
}
