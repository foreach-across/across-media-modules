...
/**
 * Imports the data entry with key {@code <root>}.
 * Allows for scoping of the entire import.
 *
 * @see WebCmsDomainContextImporter
 */
@RequiredArgsConstructor
@Component
@Order(Ordered.HIGHEST_PRECEDENCE)
public class WebCmsRootDataImporter implements WebCmsDataImporter
{
	private final WebCmsDataImportService dataImportService;

	@Override
	public boolean supports( WebCmsDataEntry data ) {
		return WebCmsDataEntry.ROOT.equals( data.getKey() );
	}
