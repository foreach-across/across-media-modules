...
public class WebCmsMenuConverter implements Converter<String, WebCmsMenu>
{
	...
	@Override
	public WebCmsMenu convert( String name ) {
		return webCmsMenuRepository.findOneByName( name );
	}
}
