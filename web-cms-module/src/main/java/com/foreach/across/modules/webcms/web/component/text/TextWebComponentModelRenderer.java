 ...
 */
@Component
public class TextWebComponentModelRenderer implements WebComponentModelRenderer<TextWebComponentModel>
{
	@Override
	...
	@Override
	public void writeComponent( TextWebComponentModel component, ThymeleafModelBuilder model ) {
