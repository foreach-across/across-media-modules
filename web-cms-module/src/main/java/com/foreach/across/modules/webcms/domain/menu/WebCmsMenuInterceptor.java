...
/**
 * Takes care of deleting {@link WebCmsMenuItem}s when deleting a menu.
 *
...
class WebCmsMenuInterceptor extends EntityInterceptorAdapter<WebCmsMenu>
{
	private final WebCmsMenuItemRepository menuItemRepository;

	@Override
	public boolean handles( Class<?> aClass ) {
		return WebCmsMenu.class.isAssignableFrom( aClass );
	}
	...
	@Override
	public void beforeDeleteAll( Class<?> entityClass ) {
