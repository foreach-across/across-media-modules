...
class TestExpiringFileRepositoryLocal extends BaseFileRepositoryTest
{
	...
	void folderIsCreated() {
		FileResource file = fileRepository.getFileResource( FileDescriptor.of( "cache:aa/bb/cc:myfile" ) );
		assertThat( fileRepository.getFolderResource( FolderDescriptor.of( "cache:aa/" ) ).exists() ).isFalse();
		assertThat( fileRepository.getFolderResource( FolderDescriptor.of( "cache:aa/bb/" ) ).exists() ).isFalse();
		assertThat( fileRepository.getFolderResource( FolderDescriptor.of( "cache:aa/bb/cc/" ) ).exists() ).isFalse();
		...
		assertThat( cc.getDescriptor() ).isEqualTo( FolderDescriptor.of( "cache:aa/bb/cc/" ) );
		...
		assertThat( bb.getDescriptor() ).isEqualTo( FolderDescriptor.of( "cache:aa/bb/" ) );
		...
		assertThat( aa.getDescriptor() ).isEqualTo( FolderDescriptor.of( "cache:aa/" ) );
		...
		assertThat( root.getDescriptor() ).isEqualTo( FolderDescriptor.rootFolder( "cache" ) );
	...
	void createFolderAndFilesInFolder() {
		FolderResource folder = fileRepository.getFolderResource( FolderDescriptor.of( "cache:dd/cc/" ) );
